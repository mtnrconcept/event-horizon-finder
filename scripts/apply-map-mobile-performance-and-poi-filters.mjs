...
const usesPrimaryVectorStyle =
  mapSource.includes("style: PRIMARY_MAP_STYLE") ||
  mapSource.includes("style: mapAssetProxyUrl(PRIMARY_MAP_STYLE) ?? PRIMARY_MAP_STYLE");
if (!usesPrimaryVectorStyle) {
