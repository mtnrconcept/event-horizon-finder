...
await update("src/routes/__root.tsx", (initial) => {
  ...
  for (const asset of ["/brand/global-party-logo.png", "/favicon.ico", "/manifest.webmanifest"]) {
