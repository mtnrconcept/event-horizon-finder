  ...
  public: {
    Tables: {
      ...
      data_sources: {
        ...
        Relationships: [
          {
            foreignKeyName: "data_sources_category_slug_fkey";
      ...
      event_scraped_details: {
        ...
        Relationships: [
          {
            foreignKeyName: "event_scraped_details_event_id_fkey";
            columns: ["event_id"];
            isOneToOne: true;
            referencedRelation: "events";
            referencedColumns: ["id"];
    ...
    Enums: {
      ...
      data_source_type:
        "official_site" | "venue_site" | "organizer_site" | "partner_feed" | "manual" | "import";
      event_status:
        | "draft"
        | "pending_review"
        | "published"
      ...
      ingestion_status:
        ...
        | "cancelled"
        | "awaiting_review";
      occurrence_status: "scheduled" | "cancelled" | "postponed" | "sold_out" | "completed";
      social_comment_status: "published" | "hidden";
      social_media_kind: "image" | "video";
      social_post_status: "draft" | "published" | "hidden";
      ticket_status: "unknown" | "available" | "limited" | "sold_out" | "free" | "on_sale_soon";
